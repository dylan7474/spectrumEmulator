...
When a recording destination is configured, press **F8** to arm the virtual deck. Each recording session clears the previous cap
ture and is written out automatically when you stop with **F6** or **F7** or exit the emulator.
